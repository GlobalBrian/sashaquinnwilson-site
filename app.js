...
const translations = {
  en: {
    ...
    strings: {
      ...
      aboutCopy2:
        "She works across campaigns in Japan and international brand projects through partner agencies, building a portfolio that blends joy, individuality, and professional camera presence.",
  ...
  ja: {
    title: "サーシャ・クイン・ウィルソン | 公式サイト",
    description:
      "キッズモデル サーシャ・クイン・ウィルソン（Sassy）の公式サイト。最新の出演情報やビジュアルを掲載しています。",
    strings: {
      navAbout: "プロフィール",
      navStyle: "スタイル",
      navPersonality: "人柄",
      ...
      heroLead:
        "豊かな表情と自然なカメラ感で、現場の空気を明るく変えるキッズモデル。サーシャらしい遊び心と品のある存在感を、毎回しっかり残します。",
      heroCtaInstagram: "Instagramを見る",
      heroCtaWork: "最新の実績を見る",
      tone1: "スタジオミニマル",
      tone2: "プレイフルポップ",
      tone3: "エディトリアルレッド",
      spotGlobalTitle: "活動エリア",
      spotGlobalCopy: "日本での撮影を中心に、海外ブランド関連プロジェクトにも参加しています。",
      spotFitTitle: "対応ジャンル",
      spotFitCopy: "ライフスタイル、ファッション、ファミリー、スポーツ系まで幅広く対応可能です。",
      spotSticker: "生まれた日からSassy",
      aboutTitle: "サーシャについて",
      aboutCopy1:
        "サーシャ・クイン・ウィルソンは、表情の引き出しの多さと自然体の存在感が魅力のキッズモデル。家族やフォロワーから<strong>Sassy</strong>と呼ばれる、明るく印象に残るキャラクターです。",
      aboutCopy2:
        "日本国内の案件を中心に、海外ブランド関連のプロジェクトにもパートナー企業経由で参加。楽しさと品のある表現を両立しながら、着実に実績を広げています。",
      styleTitle: "Sassyの表現スタイル",
      dnaLabel1: "表現力",
      dnaTitle1: "表情で魅せる",
      dnaCopy1: "視線と表情の使い分けで、印象に残る一枚を作るのが得意です。",
      dnaLabel2: "動き",
      dnaTitle2: "自然なポージング",
      dnaCopy2: "静かなカットから動きのあるカットまで、テンポよく切り替えられます。",
      dnaLabel3: "存在感",
      dnaTitle3: "カメラを惹きつける力",
      dnaCopy3: "一度見たら記憶に残るビジュアルを、安定して生み出せるのが強みです。",
      looksTitle: "得意なテイスト",
      lookTitle1: "スタジオミニマル",
      lookCopy1: "アイボリーや淡いトーンを生かした、上品でクリーンな雰囲気づくりが得意です。",
      lookTitle2: "プレイフルポップ",
      lookCopy2: "鮮やかなカラーと明るい空気感で、キッズ向け企画に映える表現ができます。",
      lookTitle3: "エディトリアル",
      lookCopy3: "コントラストの強いスタイリングでも、雰囲気に合わせて自然に表現できます。",
      personalityTitle: "オフカメラ",
      personalityIntro:
        "撮影外でも、サーシャはその場を明るくする存在。現場になじむ早さと、自然なコミュニケーション力も魅力です。",
      hobbyTitle: "趣味",
      hobby1: "ダンス練習",
      ...
      note5: "おもちゃの片づけは少し苦手",
      galleryTitle: "Instagram 最新ルックブック",
      galleryNote: "Instagramの投稿を自動反映し、最新の出演実績をご覧いただけます。",
      contactTitle: "ご依頼・お問い合わせ",
      contactCopy: "キャンペーン出演、タイアップ、撮影のご相談は、以下のメールまでご連絡ください。",
      footerCopy: "© {{year}} Sasha Quinn Wilson. All rights reserved.",
      galleryCta: "投稿を見る",
      ...
      heroCaptionNoData: "Instagram投稿を取得できないため、現在はストック画像を表示しています。"
    }
  }
};
